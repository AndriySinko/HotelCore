...
public class CreateMasterProjectCommandValidator : AbstractValidator<CreateMasterProjectCommand>
{
    public CreateMasterProjectCommandValidator()
    {
        RuleFor(x => x.WorkerProfileId)
            .NotEmpty()
